...
- AA-3 부분 완료: 200개 deterministic maze 생성, BFS teacher 평가, JSON report와 CLI 품질 게이트
- 미연결: ONNX maze 평가, 전투 replay·성격 차별성 평가, v8 model upload, GC deployed 상태
